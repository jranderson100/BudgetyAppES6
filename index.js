...
console.log(test);
*/
/*if (typeof(DOMstrings.dateLabel) == 'undefined') {
  DOMstrings.dateLabel = '.budget__title__month';
};*/
...
const updatePercentages =  () => {
  //1. Calculate percentages
budgetController.calculatePercentages();
console.log("Trying to calculate Percentages");
  //2.Read percentages from the budget controller
  let percentages = budgetController.getAllPercentages();
